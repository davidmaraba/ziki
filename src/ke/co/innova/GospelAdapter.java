...
public class GospelAdapter extends BaseAdapter {
    ...
    public GospelAdapter(Activity a, ArrayList<HashMap<String, String>> d, Context context) {
        activity = a;
        data=d;
    ...
    public GospelAdapter(Context context)
    {
    	this.context=context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       //== 		
        ...
        String songName=song.get(Gospel.TAG_SONG);
        String artistName=song.get(Gospel.TAG_ARTIST);
       ...
       // imageLoader.DisplayImage(song.get(SubscribedActivity.KEY_THUMB_URL), thumb_image);
        imageLoader.DisplayImage(song.get(Gospel.TAG_PHOTO), thumb_image);
