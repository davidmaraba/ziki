...
public class TopZikiAdapter extends BaseAdapter {
    ...
    public TopZikiAdapter(Activity a, ArrayList<HashMap<String, String>> d, Context context) {
        activity = a;
        data=d;
    ...
    public TopZikiAdapter(Context context)
    {
    	this.context=context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       //== 		
        ...
        String songName=song.get(Ziki_Hits.TAG_SONG);
        String artistName=song.get(Ziki_Hits.TAG_ARTIST);
       ...
       // imageLoader.DisplayImage(song.get(SubscribedActivity.KEY_THUMB_URL), thumb_image);
        imageLoader.DisplayImage(song.get(Ziki_Hits.TAG_PHOTO), thumb_image);
        
        
        final String path_mp3 = song.get(Ziki_Hits.TAG_MP3);
        final String path_mp4=song.get(Ziki_Hits.TAG_MP4);
        ...
        play.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				AndroidTabAndListView.playSpec.setContent(AndroidTabAndListView.playIntent);
                 AndroidTabAndListView.tabHost.getTabWidget().getChildAt(2).setVisibility(View.VISIBLE);
