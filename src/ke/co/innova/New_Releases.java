...
public class New_Releases extends ListActivity{
    ...
    public New_Releases_Adapter  adapter;
    ...
    class LoadSubscriptions extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(New_Releases.this);
...
try{
				...
				URL ziki = new URL("http://ziki.innova-africa.com/newapi/");
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                ...
                //  adapter=new LazyAdapter(new MainActivity(),subscriptionList);
                    ...
                    adapter=new New_Releases_Adapter(New_Releases.this, songsList,getApplicationContext());        
