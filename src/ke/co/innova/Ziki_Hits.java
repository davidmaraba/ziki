...
public class Ziki_Hits extends ListActivity{
    ...
    class LoadSubscriptions extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Ziki_Hits.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                ...
                //  adapter=new LazyAdapter(new MainActivity(),subscriptionList);
                    ...
                    adapter=new TopZikiAdapter(Ziki_Hits.this, songsList,getApplicationContext());        
