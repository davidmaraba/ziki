...
public class Gospel2 extends ListActivity {
	...
	class LoadInbox extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Gospel2.this);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							Gospel2.this, songsList,
							R.layout.layout_list, new String[] { TAG_SONG, TAG_ARTIST, TAG_PHOTO  },
