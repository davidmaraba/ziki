...
public class Gospel_Hits extends ListActivity{
    ...
    public Gospel_Hits_Adapter  adapter;
    ...
    class LoadSubscriptions extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Gospel_Hits.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                ...
                //  adapter=new LazyAdapter(new MainActivity(),subscriptionList);
                    ...
                    adapter=new Gospel_Hits_Adapter(Gospel_Hits.this, songsList,getApplicationContext());        
